...
class RespWaveformPopup extends StatefulWidget {
  final Color respColor;

  const RespWaveformPopup({
    Key? key,
    required this.respColor,
  }) : super(key: key);

  @override
  State<RespWaveformPopup> createState() => _RespWaveformPopupState();

  static void show(BuildContext context, Color respColor) {
    showDialog(
      context: context,
      builder: (BuildContext context) => RespWaveformPopup(respColor: respColor),
    );
  }
}

class _RespWaveformPopupState extends State<RespWaveformPopup> {
  String selectedGain = 'Auto';
  String selectedSpeed = '25';
  String selectedWaveform = 'Resp';
