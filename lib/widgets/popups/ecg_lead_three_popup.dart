...
class ECGLeadThreePopup extends StatefulWidget {
  final Color ecgColor;

  const ECGLeadThreePopup({
    Key? key,
    required this.ecgColor,
  }) : super(key: key);

  @override
  State<ECGLeadThreePopup> createState() => _ECGLeadThreePopupState();

  static void show(BuildContext context, Color ecgColor) {
    showDialog(
      context: context,
      builder: (BuildContext context) => ECGLeadThreePopup(ecgColor: ecgColor),
    );
  }
}

class _ECGLeadThreePopupState extends State<ECGLeadThreePopup> {
  String selectedMode = 'Monitoring';
  String selectedGain = 'Auto';
  String selectedSpeed = '25';
  String selectedWaveform = 'Lead III';  // Changed to Lead III
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                const Text(
                  'ECG Lead III',  // Changed to Lead III
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
