...
class MyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'myproto'), createEmptyInstance: create)
...
class MyResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MyResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'myproto'), createEmptyInstance: create)
